...
public class PayEventProducer {
    ...
    String topic = "operations-events";


    public ListenableFuture<SendResult<Integer, String>> sendPayEvent(Operation payEnvent)
            throws JsonProcessingException {
        Integer key = payEnvent.getId();
        String value = objectMapper.writeValueAsString(payEnvent);
